...
export const metadata: Metadata = {
  title: "Ymnik Chess Club - Master Strategy & Join Our Community",  description: "Join Ymnik Chess Club for weekly tournaments, expert coaching, and a vibrant community. Elevate your chess skills from beginner to master.",  keywords: "chess club, tournaments, chess coaching, chess community, online chess",  metadataBase: new URL("https://ymnikchessclub.com"),
  alternates: {
    canonical: "https://ymnikchessclub.com"
  },
  openGraph: {
    title: "Ymnik Chess Club - Master Strategy & Join Our Community",    description: "Join Ymnik Chess Club for weekly tournaments, expert coaching, and a vibrant community. Elevate your chess skills from beginner to master.",    url: "https://ymnikchessclub.com",    siteName: "Ymnik Chess Club",    type: "website",    images: [
      {
        url: "https://img.b2bpic.net/free-photo/chess-game-business-strategy-concept_53876-30572.jpg",        alt: "Ymnik Chess Club - Strategic gameplay"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Ymnik Chess Club - Master Strategy & Join Our Community",    description: "Join Ymnik Chess Club for weekly tournaments, expert coaching, and a vibrant community. Elevate your chess skills from beginner to master.",    images: ["https://img.b2bpic.net/free-photo/chess-game-business-strategy-concept_53876-30572.jpg"]
  },
  robots: {
    index: true,
    follow: true
